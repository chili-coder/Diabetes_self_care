...
public class TimeAdapter2 extends RecyclerView.Adapter<TimeAdapter2.ViewHolder> {

    private List<TimeSelectorItem> timeSelectorItems;
    private Context context;

    private TobaccoActivity homeActivity;

    public TimeAdapter2(List<TimeSelectorItem> timeSelectorItems, Context context) {
    ...
    @NonNull
    @Override
    public TimeAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.select_time_item, parent, false);

        return new TimeAdapter2.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull TimeAdapter2.ViewHolder holder, int position) {

        homeActivity = (TobaccoActivity) context;
