...
public class TimeAdapter3 extends RecyclerView.Adapter<TimeAdapter3.ViewHolder> {

    private List<TimeSelectorItem> timeSelectorItems;
    private Context context;

    private FollowupActivity homeActivity;

    public TimeAdapter3(List<TimeSelectorItem> timeSelectorItems, Context context) {
    ...
    @NonNull
    @Override
    public TimeAdapter3.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.select_time_item, parent, false);

        return new TimeAdapter3.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull TimeAdapter3.ViewHolder holder, int position) {

        homeActivity = (FollowupActivity) context;
