...
public class DatabaseHelperDiet extends SQLiteOpenHelper {


    private static final String DB_NAME = "Dietreminder";
    private static final int DB_VERSION = 1;
    private static final String DB_TABLE = "Diets";
    ...
    public DatabaseHelperDiet(Context context) {
    ...
    public void insertNewDiet(String dietName, int day, int month,
