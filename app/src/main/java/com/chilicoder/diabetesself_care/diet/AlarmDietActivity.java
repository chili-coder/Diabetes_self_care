...
public class AlarmDietActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alarm_diet);

        getSupportActionBar().setTitle("Time For Diet ");



        Intent intent = getIntent();

       clockImageView = findViewById(R.id.clock_alarm_diet); //Creating the clock icon
        ...
        String medicineName = intent.getStringExtra("dietName"); // The drug name is shown here
        // The drug name is shown here
        textViewMedicineName = findViewById(R.id.text_view_medicine_name_alarm_diet);
        textViewMedicineName.setText(medicineName);

        textViewTime = findViewById(R.id.text_view_time_alarm_diet);
        ...
        DatabaseHelperDiet databaseHelper = new DatabaseHelperDiet(this);
        ...
        buttonDismiss = findViewById(R.id.button_dismiss_diet); // button to reject alarm
        ...
        buttonSnooze = findViewById(R.id.button_snooze_diet); //snooze alarm
        ...
        buttonTake = findViewById(R.id.button_take_diet); //snooze the alarm for one day
