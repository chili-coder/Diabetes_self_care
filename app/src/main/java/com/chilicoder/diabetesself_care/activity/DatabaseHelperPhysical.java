...
public class DatabaseHelperPhysical extends SQLiteOpenHelper {


    private static final String DB_NAME = "PhysicalActivityreminder";
    private static final int DB_VERSION = 1;
    private static final String DB_TABLE = "Activity";
    ...
    public DatabaseHelperPhysical(Context context) {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String query = String.format("CREATE TABLE IF NOT EXISTS %s (" +
                ...
                "%s INTEGER NOT NULL, " +
                "%s TEXT NOT NULL, " +
                "%s TEXT NOT NULL);", DB_TABLE, KEY_ID, KEY_NAME,KEY_ACTIVITY_DURATION, KEY_DAY, KEY_MONTH, KEY_YEAR, KEY_TIMES_PER_DAY, KEY_TOTAL_DOSES, KEY_TIMINGS, KEY_ALERT_TYPE);
    ...
    public void insertNewPhysical(String activityName,String activityDuration, int day, int month,
        ...
        values.put(KEY_ACTIVITY_DURATION, activityDuration);
        ...
        Log.i("Physical Activity DB Helper",  activityName + day + month + year + noOfTimesPerDay + totalDoses + timings + alertType);
        db.close();
    }

    public void deletePhysical(String dietName) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public List<PhysicalItem> getPhysicalList() {
        List<PhysicalItem> dietList = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();

        Cursor cursor = db.query(DB_TABLE, new String[]{KEY_NAME,KEY_ACTIVITY_DURATION, KEY_TIMES_PER_DAY}, null, null, null, null, KEY_ID+" DESC");
        while (cursor.moveToNext()) {
            PhysicalItem homeItem = new PhysicalItem(cursor.getString(0)  ,"Workout "+cursor.getString(1) +" Minutes",cursor.getString(2) + " times a day");
